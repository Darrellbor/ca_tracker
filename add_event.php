...
<h1>
	...
	<p align="right">
    	<a href="saved_events.php"><input type="button" value="Back To Saved Events" /></a>  <a href="home.php"><input type="button" value="Back To Home" /></a>
    ...
    <br />
    <br />
    <form action="add_event_process.php" method="post" id="myform">
