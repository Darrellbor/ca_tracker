...
<body>
	<?php
		...
		$insert_sql=mysql_query("insert into `messages` set sender_reg_id='".$_SESSION['current_user_reg_no']."',sender_full_name='".$_SESSION['current_user_full_name']."',sender_email='".$_SESSION['current_user_email']."',sender_visible='$sender_visible',message_id='$message_id',subject='$subject',message='$message',recepient_reg_id='".$_SESSION['friend_reg_id']."',recepient_full_name='".$_SESSION['friend_full_name']."',recepient_email='".$_SESSION['friend_email']."',recepient_visible='$recepient_visible',message_viability='$message_viability',date_of_message='$date_of_message'");
		
		if($insert_sql==FALSE)
		{
			$_SESSION['message']="Error encountered sending message";
			$_SESSION['messagetype']="error";
			header("Location: send_message.php");
			exit();
		}
		
		unset($_SESSION['subject'],$_SESSION['message'],$_SESSION['friend_email'],$_SESSION['friend_full_name'],$_SESSION['friend_reg_id']);
