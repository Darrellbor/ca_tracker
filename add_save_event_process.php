<?php
	...
	require_once("db_connect.php");
		...
		{
			$_SESSION['message']="Sorry but the date of your event cannot be less than today's date!";
		...
		$add_sql=mysql_query("insert into `upcoming_events` set registration_id='".$_SESSION['current_user_reg_no']."', event_code='$event_code', title='$title', description='$description', date_of_event='$date_of_event', message_viability='new' ");
		if($add_sql==FALSE)
		{
			$_SESSION['message']="Error encountered adding event! ".mysql_error();
			$_SESSION['messagetype']="error";
			header("Location: add_new_event.php");
			exit();
		}
			...
			$_SESSION['message']="Your event has been successfully added!";
