   ...
   <?php
	...
	?>
    	<form action="almost_done_process.php" method="post" id="myform">
            ...
            <br />
            <br />
            <h2 align="center">Select your subjects</h2>
            ...
            <table align="center" cellspacing="20px" cellpadding="15px" bordercolor="#2828ff" id="data_table">
            	<?php
              ...
              <script language="javascript">
					...
					if(document.getElementById("target").value!="")
					{
						...
						var count_selected_students=0;
						var list_of_subjects_offered="";
						
						for(var count=1; count<38; count++)
						{
						...
						if(count_selected_subjects<subject_no || count_selected_subjects>subject_no)
						{
							alert("The number of subjects you selectd is below the required number of subjects you inputed earlier!");
							return null;
						}
						
						var len=list_of_subjects_offered.length;
						list_of_subjects_offered=list_of_subjects_offered.substr(len-2,2);
