<?php
	...
	$main_menu="Notes";
	$sub_menu="Add New Note";
	
	$title=isset($_SESSION['title']) ? trim($_SESSION['title']) : "";
	$note=isset($_SESSION['note']) ? trim($_SESSION['note']) : "";
?>
...
<?php echo $_SESSION['current_term']; ?>,<?php echo $_SESSION['current_session']; ?> <br /> 
    ...
    <form action="add_new_note_process.php" method="post" id="myform">
    	<table align="center" id="data_table" cellpadding="10px" cellspacing="1px" style="color:#007DFB;">
            ...
            <tr>
           		<td align="center" colspan="2"><input type="button" value="Add Note" onclick="add_note_cllck()" /></td>
            </tr>
            
            <script language="javascript">
				function add_note_cllck()
				{
					...
					{
						alert("Please make sure that your note is not empty");
