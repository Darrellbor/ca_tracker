...
<body>
	...
	if($insert_up_event=FALSE)
	{
		...
		$_SESSION['messagetype']="error";
		header("Location: add_events1.php");
		exit();
	}
	
	$del_saved_event=mysql_query("delete from `deleted/passed_events` where (registration_id='".$_SESSION['reg_id']."' and event_code='".$_SESSION['event_code']."')");
